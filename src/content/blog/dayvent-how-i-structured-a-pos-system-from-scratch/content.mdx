...
Para el trabajo asíncono uso una cola con **Cloud Tasks**. En Go lo ideal para ejecutar tareas asíncronas después de responderle al cliente es hacer lo siguiente:
